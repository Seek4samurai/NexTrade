...
const style = {
  ...
  description: `text-[#e1e1e1] container-[400px] text-2xl mt-[0.8rem] mb-[2.5rem]`,
  ctaContainer: `flex`,
      ...
      <div className={style.container}>
        <div className={style.contentWrapper}>
          <div className={style.copyContainer}>
            <div className={style.title}>Discover something new.</div>
            <div className={style.description}>
              An NFT marketplace for awesome investers
            </div>
            <div className={style.ctaContainer}>
              <div className={style.button}>Explore</div>
            </div>
          </div>
        </div>
      </div>
